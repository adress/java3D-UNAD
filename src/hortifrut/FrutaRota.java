...
public class FrutaRota extends Applet {
    ...
    public BranchGroup createSceneGraph() {
        ...
        /*funcion de tiempos indica la cantidade ciclos y la duracion de la transicion
        se le indica ciclos inifinitos con duracion de 4 */
        Alpha rotationAlpha = new Alpha(-1, 4000);
        
        /*clase de java3d para animaciones de rotacion*/
    ...
    public static void main(String[] args) {
        ...
        Frame frame = new MainFrame(new FrutaRota(), 511, 341);
    }
}
