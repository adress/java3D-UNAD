...
public class FrutaTranslada extends Applet {
...
//                            float endPosition)
//                
        /*clase predefinida en java3d para animaciones de posicion*/
        PositionInterpolator transladaor
                = new PositionInterpolator(alpha6Obj, objSpin, xAxis, -0.9f, 0.9f);

        // se crea una esfera delimitadora especifica una región donde un comportamiento está activo
        BoundingSphere bounds = new BoundingSphere();
        transladaor.setSchedulingBounds(bounds);
        objSpin.addChild(transladaor);
        ...
        //se crea un poligono con las 4 esquinas de la pantalla
    ...
    public static void main(String[] args) {
        ...
        Frame frame = new MainFrame(new FrutaTranslada(), 511, 341);
    }
}
